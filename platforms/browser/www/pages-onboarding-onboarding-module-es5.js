...
var OnboardingPageRoutingModule = /** @class */ (function () {
    function OnboardingPageRoutingModule() {
    }
...
var OnboardingPage = /** @class */ (function () {
    function OnboardingPage(formBuilder, toastService, storage, menuCtrl, router, route, http, loadingService) {
    ...
    OnboardingPage.prototype.submit_mobile_number = function () {
    ...
    OnboardingPage.prototype.resendOtp = function () {
        this.mobile.reset();
        this.onboarding_stage = 1;
    };
    OnboardingPage.prototype.sendOtp = function () {
    ...
    OnboardingPage.prototype.submit_otp = function () {
        var _this = this;
            ...
            if (this.otp.value == this.generated_otp) {
                ...
                this.http.call('post', 'api/login', JSON.stringify({ mobile: this.mobile.value }))
                    ...
                    if (res.error === false) {
                        ...
                        _this.storage.set('user', res.response);
                        _this.onboarding_stage = 1;
                        ...
                        _this.register = _this.formBuilder.group({
                            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
                            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
                        });
                        _this.onboarding_stage = 3;
                    }
                });
            }
            else {
    ...
    OnboardingPage.prototype.register_user = function () {
        var _this = this;
        console.log(this.register);
        if (this.register.valid) {
            var body = this.register.value;
