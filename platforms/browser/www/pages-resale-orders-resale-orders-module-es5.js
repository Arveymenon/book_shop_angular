...
var ResaleOrdersPageRoutingModule = /** @class */ (function () {
    function ResaleOrdersPageRoutingModule() {
    }
    ...
    return ResaleOrdersPageRoutingModule;
}());
...
var ResaleOrdersPageModule = /** @class */ (function () {
    function ResaleOrdersPageModule() {
    }
...
var ResaleOrdersPage = /** @class */ (function () {
    function ResaleOrdersPage(http, storage, router) {
        this.http = http;
    ...
    ResaleOrdersPage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('user').then(function (user) {
            _this.http.call('get', 'api/resale/user/' + user.id).then(function (data) {
                console.log(data);
                if (data.error == false) {
                    _this.resaleOrders = data.response;
                }
            });
        });
    };
    ResaleOrdersPage.prototype.details = function (resaleId) {
        this.router.navigate(['resale-order-details', resaleId]);
    };
    ResaleOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-resale-orders-resale-orders-module-es5.js.map