...
let ResaleConfimrationComponent = class ResaleConfimrationComponent {
    constructor(storage, http, modalctrl, modalController) {
...
ResaleConfimrationComponent.ctorParameters = () => [
...
let OrderDetailsPage = class OrderDetailsPage {
    constructor(router, cartService, route, http, storage, toast, location, modalController) {
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.cartService.getBooks().then((res) => {
            this.books = res;
    ...
    requestResale() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            modal.onDidDismiss().then(res => {
                ...
                console.log(body);
                this.http.call('post', 'api/resale/post', body).then((data) => {
                    console.log(data);
                    if (data.error == false) {
