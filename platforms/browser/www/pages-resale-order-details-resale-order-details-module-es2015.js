...
let ResaleOrderDetailsPageRoutingModule = class ResaleOrderDetailsPageRoutingModule {
};
...
let ResaleOrderDetailsPageModule = class ResaleOrderDetailsPageModule {
};
...
let ResaleOrderDetailsPage = class ResaleOrderDetailsPage {
    ...
    ngOnInit() {
        this.route.paramMap.subscribe((params) => {
            console.log(params);
            this.http.call('get', 'api/resale/order/details/' + params.params.id).then((data) => {
                console.log(data);
                if (data.error == false) {
...
ResaleOrderDetailsPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-resale-order-details-resale-order-details-module-es2015.js.map