...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.addProduct = function (ProductId, productType, product) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            var BookItt;
            if (productType == 1) {
                BookItt = _this.books.findIndex(function (o) { return (o.id == ProductId); });
                console.log(BookItt);
                _this.books[BookItt].quantity_in_cart += 1;
            }
            var cartBookItt = _this.cart.findIndex(function (o) { return (o.book.id == ProductId && o.product_type == productType); }); // All type. not only books
            ...
            if (cartBookItt > -1) {
                ...
                var newProduct = {};
                newProduct.book = _this.books[BookItt] ? _this.books[BookItt] : product;
    ...
    CartService.prototype.removeProduct = function (productId, productType, product) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (productType == 1) {
                var BookItt = _this.books.findIndex(function (o) { return (o.id == productId); });
                console.log(BookItt);
                if (BookItt > -1)
                    _this.books[BookItt].quantity_in_cart -= 1;
            }
            ...
            console.log(_this.cart);
            console.log(productId);
            var bookItt = _this.cart.findIndex(function (o) { return (o.book.id === productId && o.product_type === productType); });
            console.log(bookItt);
            if (bookItt > -1) {
                var est = _this.cart[bookItt].quantity_in_cart;
                if (est - 1 != 0) {
                    _this.cart[bookItt].quantity_in_cart -= 1;
                    _this.setCart(_this.cart).then(function () {
                        resolve(_this.cart);
                        _this.calculate();
                    });
    ...
    CartService.prototype.removeBook = function (viewBookItt) {
    };
