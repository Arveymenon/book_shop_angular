...
/* harmony import */ var _cart_cart_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../cart/cart.service */ "./src/app/services/cart/cart.service.ts");
...
var PaymentService = /** @class */ (function () {
    function PaymentService(cartService, storage) {
    ...
    PaymentService.prototype.pay = function (amount) {
        ...
        return new Promise(function (res, rej) {
            _this.cartService.calculate().then(function (total) {
                console.log(total);
