...
let CartPage = class CartPage {
    constructor(router, cartService, http, alertController, ref, payment, storage, loadingService) {
        this.router = router;
    ...
    remove(itt) {
        this.cartService.removeProduct(this.cartService.cart[itt].book.id, this.cartService.cart[itt].product_type).then((res) => {
            console.log(res);
        });
    }
    refurbished_price(itt) {
        this.cartService.refurbishedToggle(this.cartService.cart[itt].id).then((res) => {
            console.log(res);
